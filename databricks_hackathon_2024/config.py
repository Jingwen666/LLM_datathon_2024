...
run_name_chatbot_creation = f'asset_nav_chatbot_model_chunk_{desired_chunk_size}_k_{desired_k_value}'

## chatbot run_name_in_rag_evaluation_notebook
run_name_evaluation = f'asset_nav_chunk_{desired_chunk_size}_k_{desired_k_value}'

# automated inference use case
catalog = "main"
# VECTOR_SEARCH_ENDPOINT_NAME="asset_nav_vector_search_endpoint_chunk_fourhundred"
VECTOR_SEARCH_ENDPOINT_NAME="assetnav_vse_chunk_fourhundred_k_five"
